...
<body>
    ...
    <?php 
        ...
        $minRate = 3;
        function yText($object1,$object2){
          return strlen($object2->reviewFullText)-strlen($object1->reviewFullText);
        };
        function nText($object1,$object2){
          return strlen($object1->reviewFullText)-strlen($object2->reviewFullText);
        };
        function hRate($object1,$object2){
        ...
        function lRate($object1,$object2){
          if($object1->rating == $object2->rating)
            return 0;
          if($object1->rating < $object2->rating)
            return -1;
        ...
        function oDate($object1,$object2){
          if($object1->reviewCreatedOnDate == $object2->reviewCreatedOnDate)
            return 0;
          if($object1->reviewCreatedOnDate < $object2->reviewCreatedOnDate)
            return -1;
          else
        ...
        function nDate($object1,$object2){
          if($object1->reviewCreatedOnDate == $object2->reviewCreatedOnDate)
            return 0;
          if($object1->reviewCreatedOnDate < $object2->reviewCreatedOnDate)
            return 1;
        ...
        function filter($json_data,$minRate){
          foreach($json_data as $key=>$object){
            if($object->rating > $minRate){
              return $object;
            }
          }
        }
        ...
        if(isset($_GET['submit'])){
          $byRate = $_GET['byRate'];$_GET['rate'];$_GET['byDate'];$_GET['byText'];
          echo $byRate;
        };
    ...
    <form action="" method="get">
        <label for="byRate">Order by rating:</label>
        <select id="byRate" name="byRate" size="3">
            <option value="high">Highest First</option>
            <option value="low">Lowest First</option>
        </select>

        <label for="rate">Minimum rating:</label>
        <select id="rate" name="rating" size="3">
        ...
        <label for="byDate">Order by date:</label>
        <select id="byDate" name="byDate" size="3">
            <option value="new">Newest First</option>
            <option value="old">Oldest First</option>
        </select>

        <label for="byText">Prioritize by text:</label>
        <select id="byText" name="byText" size="3">
